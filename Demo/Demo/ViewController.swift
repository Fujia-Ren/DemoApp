...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        usefulButton.addTarget(self, action: #selector(usefulButtonPressed), for: .touchUpInside)
        ...
        //Thanks Steve. Couldn't get this to work
        ...
        let image: UIImage = UIImage(named: "dinosaur")!
        decoration = UIImageView(image: image)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            decoration.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            decoration.topAnchor.constraint(equalTo: usefulButton.bottomAnchor, constant: -10)
            ])
    }
    
    @objc func usefulButtonPressed(sender: UIButton) {
        let temp = decoViewController()
